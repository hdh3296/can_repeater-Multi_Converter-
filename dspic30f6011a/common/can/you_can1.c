...
unsigned    char    Can1TxGroupAddr=0;
unsigned    char    Can1TxLocalAddr=0;
...
Can1RxGroupAddr = (unsigned char)(Can1RxSid >> 7);
if(Can1RxEid & 0x20000)	Can1RxGroupAddr = (Can1RxGroupAddr | 0x10);
	 

Can1RxLocalAddr = (unsigned char)(Can1RxEid >> 14);
Can1RxLocalAddr = (unsigned char)(Can1RxLocalAddr &  0x07);
