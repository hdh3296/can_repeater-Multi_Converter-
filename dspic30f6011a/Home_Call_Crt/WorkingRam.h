...
#define GET_LONG_BIT_FIELD(addr)          (*((volatile bit_field32*) (addr)))
...
extern  unsigned long    		Ram_Area1_bit;
extern  unsigned long    		Ram_Area2_bit;
extern  unsigned long    		Ram_Area3_bit;
extern  unsigned long    		Ram_Area4_bit;



#define  HostCallMe             GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit0
#define  UpMove              	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit1
#define  DnMove           		GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit2
#define  FloorChange            GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit3
#define  ManualToggle          	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit4
#define  CarMove               	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit5
#define  KeyClr             	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit6
#define  Auto                 	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit7
#define  FDsp               	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit8
#define  Parking              	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit9
#define  Vip           			GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit10
#define  Fire                	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit11
#define  ShiftOn          		GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit12
#define  Open               	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit13
#define  Close             		GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit14
#define  UpKeyBit             	GET_LONG_BIT_FIELD(&Ram_Area1_bit).bit15




#define  DnKeyBit             	GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit0
#define  Emg              		GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit1
#define  StopBit           		GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit2
#define  Full            		GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit3
#define  OverLoad          		GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit4
#define  KeyClrExt              GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit5
#define  LowOn             		GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit6
#define  HighOn                 GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit7
#define  BlinkOn               	GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit8
#define  HallLampUpBit        	GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit9
#define  HallLampDnBit          GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit10
#define  Up_Key_Valid           GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit11
#define  Up_Key_Clear          	GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit12
#define  Dn_Key_Valid           GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit13
#define  Dn_Key_Clear           GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit14
#define  CurKey               	GET_LONG_BIT_FIELD(&Ram_Area2_bit).bit15


#define  SetupBit             	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit0
#define  TogUpKeyBitSet         GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit1
#define  TogUpKeyBitReset       GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit2
#define  TogDnKeyBitSet         GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit3
#define  TogDnKeyBitReset       GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit4
#define  b_vip               	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit5
#define  b_MyFamily            	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit6
#define  bIamXSubDoor           GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit7
#define  ExtCallKey             GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit8
#define  bHALL_LAMP_UP          GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit9
#define  bSensorButton          GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit10
#define  bCardKeyValid          GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit11
#define  UP_KEY_LAMP          	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit12
#define  DN_KEY_LAMP            GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit13
#define  CmpSetBit            	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit14
#define  MaskSetBit            	GET_LONG_BIT_FIELD(&Ram_Area3_bit).bit15





#define  ChangeSetup          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit0
#define  bToggleOn         	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit1
#define  bCurOpenKey       	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit2
#define  tmp_x_bit_03         	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit3
#define  UpKeyOn       	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit4
#define  UpKeyLong        	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit5
#define  UpKeyOneTouch           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit6
#define  DnKeyOn           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit7
#define  DnKeyLong           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit8
#define  DnKeyOneTouch          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit9
#define  tmp_x_bit_10          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit10
#define  tmp_x_bit_11          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit11
#define  tmp_x_bit_12          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit12
#define  tmp_x_bit_13          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit13
#define  bUserLamp4          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit14
#define  tmp_x_bit_15           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit15



/*
#define  tmp_x_bit_00          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit0
#define  tmp_x_bit_01         	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit1
#define  tmp_x_bit_02       	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit2
#define  tmp_x_bit_03         	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit3
#define  tmp_x_bit_04       	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit4
#define  tmp_x_bit_05        	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit5
#define  tmp_x_bit_06           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit6
#define  tmp_x_bit_07           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit7
#define  tmp_x_bit_08           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit8
#define  tmp_x_bit_09          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit9
#define  tmp_x_bit_10          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit10
#define  tmp_x_bit_11          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit11
#define  tmp_x_bit_12          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit12
#define  tmp_x_bit_13          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit13
#define  tmp_x_bit_14          	GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit14
#define  tmp_x_bit_15           GET_LONG_BIT_FIELD(&Ram_Area4_bit).bit15
*/
