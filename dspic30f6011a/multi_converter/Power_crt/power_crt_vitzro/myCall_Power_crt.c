...
//name setting
	ReqHost[0].Ho_Host[2]=VIPAM_3000_FI;
	ReqHost[1].Ho_Host[2]=VIPAM_3000_FI;
	ReqHost[2].Ho_Host[2]=VIDER_DC;
	ReqHost[3].Ho_Host[2]=GIPAM_115;
	ReqHost[4].Ho_Host[2]=VIDER_M20;
	ReqHost[5].Ho_Host[2]=VIDER_M20;
	ReqHost[6].Ho_Host[2]=VIDER_M20;
	ReqHost[7].Ho_Host[2]=VIDER_M20;
	ReqHost[8].Ho_Host[2]=VIDER_M20;
